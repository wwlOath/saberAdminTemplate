...
<script>
  import {add, getList, getTreeList, getApiscopeList, remove, } from "@/api/authority/apiscope";
  ...
  export default {
    ...
    methods: {
      ...
      settingOnLoad(page, params = {}) {
        ...
        getApiscopeList(this.dataId, page.currentPage, page.pageSize, Object.assign(params, this.settingQuery)).then(res => {
