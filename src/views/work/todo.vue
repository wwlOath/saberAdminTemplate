...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onLoad(page, params = {}) {
        this.loading = true;
        getTodoList(page.currentPage, page.pageSize, Object.assign(params, this.query)).then(res => {
          if(res.status == 200) {
      ...
      //处理
      processFunc(data) {
        this.$router.push({path: `/work/process/leave/handle/${data.taskId}/${data.processInstanceId}/${data.businessId}`});
      },
      //详情
      workDetail(data) {
